...
/**
 * Implements a specialized class similar to a Properties object in order to
 * hold configuration data and results for benchmarks. This class has the
 * following special capabilities: <li>
 * <ol>
 * The class is fully thread-safe. All accesses to property data are
 * synchronized.
 * </ol>
 * <ol>
 * The class provides metadata on stored properties to aid output.
 * </ol>
 * </li> One instance of this class is generated for each benchmark test case.
 * 
 * @author rhodges
 */
public class Config
{
    ...
    /**
     * Initializes the properties by supplying defaults and ensuring all
     * properties have metadata values.
     */
    private void init(SortedMap<String, String> propertyMap,
            ConfigMetadata metadata) throws BenchmarkException
    {
        ...
        while (names.hasNext())
        {
            ...
            if (synchronizedMap.get(name) == null)
                synchronizedMap.put(name, metadata.getPropertyMetadata(name)
                        .getDefaultValue());
        }
    }
