 ...
 * Contributor(s): Csaba Endre Simon
 */
  ...
  public DataGenerator getGenerator(Column c)
  {
    switch (c.getType())
    {
      ...
      case java.sql.Types.NCHAR:
          return new DataGeneratorForUTF8(c.getLength());
      case java.sql.Types.NVARCHAR:
          return new DataGeneratorForUTF8(c.getLength());
      case AdditionalTypes.INTERVALDS :
          return new DataGeneratorForIntervalDayToSecond(c.getLength(), c.getPrecision());
      case AdditionalTypes.INTERVALYM :
          return new DataGeneratorForIntervalYearToMonth(c.getLength());
