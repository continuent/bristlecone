 ...
 * Contributor(s): Linas Virbalas, Csaba Endre Simon
 */
...
public class SqlDialectForOracle extends AbstractSqlDialect
{
    ...
    public String implementationColumnSpecification(Column col)
    {
        switch (col.getType())
        {
            ...
            case Types.FLOAT :
                return col.getName() + " FLOAT ";
            case Types.DOUBLE :
                return col.getName() + " DOUBLE PRECISION ";
            ...
            case Types.NCHAR :
                return col.getName() + " NCHAR(" + col.getLength() + ") ";
            case Types.NVARCHAR :
                return col.getName() + " NVARCHAR2(" + col.getLength() + ") ";
            case AdditionalTypes.INTERVALDS :
                return col.getName() + " INTERVAL DAY (" + col.getLength()
                        + ")" + " TO SECOND (" + col.getPrecision() + ") ";
            case AdditionalTypes.INTERVALYM :
                return col.getName() + " INTERVAL YEAR (" + col.getLength()
                        + ")" + " TO MONTH ";
            case Types.NCLOB :
                return col.getName() + " NCLOB ";
            default :
                return super.implementationColumnSpecification(col);
        }
    }
     ...
     * special introducer for XML, BLOB, CLOB, NCLOB, time and timestamp holding
     * columns.
     */
    @Override
    public String getSelectAllSorted(Table t)
    {
        ...
        for (i = 0; i < ncols; i++)
        {
            ...
            if (col.getType() == java.sql.Types.BLOB
                    ...
                    || col.getType() == java.sql.Types.NCLOB
